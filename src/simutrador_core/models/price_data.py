...
class PriceQuote(BaseModel):
    ...
    bid: Decimal | None = Field(None, description="Bid price", gt=0)
    ask: Decimal | None = Field(None, description="Ask price", gt=0)
    volume: Decimal | None = Field(None, description="Current volume", ge=0)
